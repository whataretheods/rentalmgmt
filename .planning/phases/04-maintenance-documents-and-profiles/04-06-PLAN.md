...
<task type="checkpoint:human-verify" gate="blocking">
  <name>Task 2: Verify complete Phase 4 E2E test suite</name>
  <files></files>
  <what-built>
...
All Playwright E2E tests have been created and the test seed script is ready.
  ...
  <action>Run E2E test suite headless to verify all Phase 4 features</action>
  <how-to-verify>
...
5. Manual spot-check (optional):
  ...
  <verify>
    <automated>cd /Users/odesantos/Documents/rentalmgmt && npx playwright test e2e/maintenance.spec.ts e2e/documents.spec.ts e2e/profile.spec.ts 2>&1 | tail -20</automated>
  </verify>
  <done>All Playwright E2E tests pass in headless mode. All 6 Phase 4 requirements verified end-to-end.</done>
